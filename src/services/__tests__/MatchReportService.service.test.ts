...
import { matchReportRepository } from "../../repositories/MatchReportRepository.repository.js"
import { matchReportService } from "../MatchReportService.service.js"
import { NotFoundException } from "../../exceptions/application/NotFoundException.exception.js"

jest.mock('../../repositories/MatchReportRepository.repository', () => ({
